...
function sumarproductos(preciounitario,cantdeseada){
    let total = preciounitario * cantdeseada;
    return total;
}

pagar = sumarproductos(preciounitario,cantdeseada);
console.log("el total gastado es $ " + pagar)